...
const schema = yup.object().shape({
  ...
  TypeId: yup.string().required("TypeId name is required"), 
      ...
      >
       <FlexBox
        ...
        >
          ...
          <FormItem
            label={<Label required>companyId</Label>}
            style={{ flex: "1 1 48%" }}
          >
            <Controller
              name="companyId"
          ...
          <FlexBox direction="Column" style={{ flex: "1 1 18%" }}>
            <Label>Form Type</Label>
          <FormItem
            label={<Label required>formId</Label>}
            style={{ flex: "1 1 48%" }}
          >
            <Controller
              name="formId"
          ...
          <FlexBox direction="Column" style={{ flex: "1 1 18%" }}>
            <Label>Form Type</Label>
          <FormItem
            label={<Label required>TypeId</Label>}
            style={{ flex: "1 1 48%" }}
          >
            <Controller
              name="TypeId"
              ...
              render={({ field }) => (
                <Select
                  ...
                  value={field.value ?? ""}
                  onChange={(e) => field.onChange(e.target.value)}
                  valueState={errors.TypeId ? "Error" : "None"}
                >
                  <Option  value={"Item"}>
                        {"Item"}
                      </Option>
