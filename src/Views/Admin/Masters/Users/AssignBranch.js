...
import { CheckBox, ComboBox, ComboBoxItem, FlexBox, FormItem, Label, Option, Select, Switch, Title } from '@ui5/webcomponents-react';
            ...
            <FlexBox direction="Column" style={{ margin: "1rem" }}>
              ...
              >
                ...
                <Select
                  ...
                  style={{ width: "500px" }}
                >
                  {companies.map(val=><Option value="1">{val.name}</Option>)}
                </Select>
              </FlexBox>
{selectedCompany && (<>
              <Label
              ...
              {selectedCompany.Branches?.map((branch) => (<CheckBox
                style={{
                  justifyContent: "flex-start",
                  textAlign: "left",
                  width: "100%",
